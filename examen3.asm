...
section .data
        msj1 db 'el numero o numeros que se repite mas es:'
  	len1 equ $ -msj1
...
;***************** elementos: 4 0 1 1 6 5 9 0 2 ******************
	    ...
	    comparar_elemento:         ; etiqueta para el primer elemento o elemento anterior a comparar
                ...
                bucle:                 ; caso contrario se va al bucle
                  ...
                  jb comparar_elemento ; se activa la bandera si ecx es monor a 9
                              ; caso contrario hace un salto para salir del programa
                  jmp imp
    ...
    ;_____________IMprime el mayor de todos los numero del areglo_______________
         ...
         imprimir:
            ...
            pop ecx
            mov [res+ecx],al
                         ; se envia el valor del numero que se repite a la variable res
            
            inc ecx
           
            push ecx
            jmp bucle             ; se imprime el numero que se repite
